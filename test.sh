...
for model_name in llama-13b alpaca-13b vicuna-13b-v1.2-b128l2 vicuna-13b-v1.2-gpt4-only; do
#for model_name in vicuna-7b-abl-selected-cp188 vicuna-7b-abl-selected-cp329 vicuna-7b-abl-selected-cp376; do
    load_option=""
